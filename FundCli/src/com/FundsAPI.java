...
public class FundsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
		{ 
			 String output = fundObj.insertFund(request.getParameter("FundRecipient"), 
					 							request.getParameter("CompanyName"), 
					 							request.getParameter("TimeDuration"), 
					 							request.getParameter("Purpose"),
					 							request.getParameter("DonationAmount")); 
			...
			protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
			{
				Map paras = getParasMap(request); 
				 ...
				 paras.get("FundRecipient").toString(), 
				 paras.get("CompanyName").toString(), 
				 paras.get("TimeDuration").toString(), 
				 paras.get("Purpose").toString(),
				 paras.get("DonationAmount").toString()); 
